...
namespace RebrewsWeb
{
    ...
    public class ApplicationUserManager : UserManager<ApiUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<ApiUser>(context.Get<RebrewsDataContext>()));
            ...
            {
                manager.UserTokenProvider = new DataProtectorTokenProvider<ApiUser>(dataProtectionProvider.Create("ASP.NET Identity"));
            }
            return manager;
        }
    }
